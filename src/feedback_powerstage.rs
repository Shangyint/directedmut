...
#[derive(Clone, Debug)]
pub struct FeedbackPowerMutationalStage<E, F, EM, I, M, O, OT, S, Z>
where
...
impl<E, F, EM, I, M, O, OT, S, Z> MutationalStage<E, EM, I, M, S, Z>
    for FeedbackPowerMutationalStage<E, F, EM, I, M, O, OT, S, Z>
where
    E: Executor<EM, I, S, Z> + HasObservers<I, OT, S>,
    F: TestcaseScore<I, S>,
    I: Input,
...
impl<E, F, EM, I, M, O, OT, S, Z> FeedbackPowerMutationalStage<E, F, EM, I, M, O, OT, S, Z>
where
    E: Executor<EM, I, S, Z> + HasObservers<I, OT, S>,
    F: TestcaseScore<I, S>,
    I: Input,
    ...
    Z: Evaluator<E, EM, I, S>,
{
    /// Creates a new [`FeedbackPowerMutationalStage`]
...
pub type StdFeedbackPowerMutationalStage<E, EM, I, M, O, OT, S, Z> =
    FeedbackPowerMutationalStage<E, CorpusPowerTestcaseScore<I, S>, EM, I, M, O, OT, S, Z>;
